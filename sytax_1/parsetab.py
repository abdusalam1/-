...
_lr_productions = [
  ...
  ('pascal -> programstruct','pascal',1,'p_pascal_program','yacc.py',9),
  ('programstruct -> program_head SEMICOLON program_body POINT','programstruct',4,'p_programstruct','yacc.py',12),
  ('program_head -> PROGRAM ID LPAREN idlist RPAREN','program_head',5,'p_program_head','yacc.py',15),
  ('program_head -> PROGRAM ID','program_head',2,'p_program_head_jusi_id','yacc.py',18),
  ('program_body -> const_declarations var_declarations subprogram_declarations compound_statement','program_body',4,'p_program_body','yacc.py',21),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',24),
  ('idlist -> ID','idlist',1,'p_idlist','yacc.py',28),
  ('idlist -> idlist COM ID','idlist',3,'p_idlist_2','yacc.py',31),
  ('const_declarations -> empty','const_declarations',1,'p_const_declerations_empty','yacc.py',34),
  ('const_declarations -> CONST const_declaration SEMICOLON','const_declarations',3,'p_const_declerations','yacc.py',37),
  ('const_declaration -> ID EQUAL const_value','const_declaration',3,'p_const_decleration','yacc.py',41),
  ('const_declaration -> const_declaration SEMICOLON ID EQUAL const_value','const_declaration',5,'p_const_decleration_2','yacc.py',44),
  ('const_value -> ADDOP num','const_value',2,'p_const_value_addop','yacc.py',47),
  ('const_value -> num','const_value',1,'p_const_value_num','yacc.py',50),
  ('const_value -> LETTERS','const_value',1,'p_const_value_letter','yacc.py',53),
  ('num -> DIGITS fraction','num',2,'p_num_fraction','yacc.py',57),
  ('num -> DIGITS','num',1,'p_num_digit','yacc.py',60),
  ('fraction -> POINT DIGITS','fraction',2,'p_fraction','yacc.py',63),
  ('var_declarations -> VAR var_declaration SEMICOLON','var_declarations',3,'p_var_declarations','yacc.py',66),
  ('var_declarations -> empty','var_declarations',1,'p_var_declarations_empty','yacc.py',69),
  ('var_declaration -> idlist COLON type','var_declaration',3,'p_var_declaration','yacc.py',72),
  ('var_declaration -> var_declaration SEMICOLON idlist COLON type','var_declaration',5,'p_var_declaration_var','yacc.py',75),
  ('type -> basic_type','type',1,'p_type','yacc.py',78),
  ('type -> ARRAY LBRACKET period RBRACKET OF basic_type','type',6,'p_type_array','yacc.py',81),
  ('basic_type -> INTEGER','basic_type',1,'p_basic_type_integer','yacc.py',84),
  ('basic_type -> REAL','basic_type',1,'p_basic_type_real','yacc.py',87),
  ('basic_type -> BOOLEAN','basic_type',1,'p_basic_type_boolean','yacc.py',90),
  ('basic_type -> CHAR','basic_type',1,'p_basic_type_char','yacc.py',93),
  ('period -> DIGITS DOT DIGITS','period',3,'p_period','yacc.py',96),
  ('period -> period COM DIGITS DOT DIGITS','period',5,'p_period_2','yacc.py',99),
  ('subprogram_declarations -> subprogram_declarations subprogram SEMICOLON','subprogram_declarations',3,'p_subprogram_declarations','yacc.py',102),
  ('subprogram_declarations -> empty','subprogram_declarations',1,'p_subprogram_declarations_empty','yacc.py',105),
  ('subprogram -> subprogram_head SEMICOLON subprogram_body','subprogram',3,'p_subprogram','yacc.py',108),
  ('subprogram_head -> PROCEDURE ID formal_parameter','subprogram_head',3,'p_subprogram_head_procedure','yacc.py',111),
  ('subprogram_head -> FUNCTION ID formal_parameter COLON basic_type','subprogram_head',5,'p_subprogram_head_function','yacc.py',114),
  ('formal_parameter -> LPAREN parameter_list RPAREN','formal_parameter',3,'p_formal_parameter','yacc.py',117),
  ('formal_parameter -> empty','formal_parameter',1,'p_formal_parameter_empty','yacc.py',120),
  ('parameter_list -> parameter','parameter_list',1,'p_parameter_list','yacc.py',124),
  ('parameter_list -> parameter_list SEMICOLON parameter','parameter_list',3,'p_parameter_list_2','yacc.py',127),
  ('parameter -> var_parameter','parameter',1,'p_parameter','yacc.py',130),
  ('parameter -> value_parameter','parameter',1,'p_parameter_value','yacc.py',133),
  ('var_parameter -> VAR value_parameter','var_parameter',2,'p_var_parameter','yacc.py',136),
  ('value_parameter -> idlist COLON basic_type','value_parameter',3,'p_value_parameter','yacc.py',139),
  ('subprogram_body -> const_declarations var_declarations compound_statement','subprogram_body',3,'p_subprogram_body','yacc.py',142),
  ('compound_statement -> BEGIN statement_list END','compound_statement',3,'p_compound_statement','yacc.py',145),
  ('statement_list -> statement','statement_list',1,'p_statement_list','yacc.py',149),
  ('statement_list -> statement_list SEMICOLON statement','statement_list',3,'p_statement_list_2','yacc.py',152),
  ('statement -> empty','statement',1,'p_statement_empty','yacc.py',155),
  ('statement -> variable ASSIGNOP expression','statement',3,'p_statement_variable_assign','yacc.py',159),
  ('statement -> func_id ASSIGNOP expression','statement',3,'p_statement_func_assign','yacc.py',163),
  ('func_id -> ID','func_id',1,'p_func_id','yacc.py',167),
  ('statement -> procedure_call','statement',1,'p_statement_procedure_call','yacc.py',170),
  ('statement -> compound_statement','statement',1,'p_statement_compound','yacc.py',174),
  ('statement -> IF expression THEN statement else_part','statement',5,'p_statement_if','yacc.py',178),
  ('statement -> FOR ID ASSIGNOP expression TO expression DO statement','statement',8,'p_statement_for','yacc.py',182),
  ('statement -> READ LPAREN variable_list RPAREN','statement',4,'p_statement_read','yacc.py',186),
  ('statement -> WRITE LPAREN expression_list RPAREN','statement',4,'p_statement_write','yacc.py',190),
  ('variable_list -> variable','variable_list',1,'p_variable_list_single','yacc.py',194),
  ('variable_list -> variable_list COM variable','variable_list',3,'p_variable_list_multiple','yacc.py',198),
  ('variable -> ID id_varpart','variable',2,'p_variable','yacc.py',203),
  ('id_varpart -> empty','id_varpart',1,'p_id_varpart_empty','yacc.py',206),
  ('id_varpart -> LBRACKET expression_list RBRACKET','id_varpart',3,'p_id_varpart_with_indices','yacc.py',210),
  ('procedure_call -> ID','procedure_call',1,'p_procedure_call_no_args','yacc.py',214),
  ('procedure_call -> ID LPAREN expression_list RPAREN','procedure_call',4,'p_procedure_call_with_args','yacc.py',218),
  ('else_part -> ELSE statement','else_part',2,'p_else_part','yacc.py',224),
  ('else_part -> empty','else_part',1,'p_else_part_empty','yacc.py',227),
  ('expression_list -> expression','expression_list',1,'p_expression_list_single','yacc.py',230),
  ('expression_list -> expression_list COM expression','expression_list',3,'p_expression_list_multiple','yacc.py',234),
  ('expression -> simple_expression','expression',1,'p_expression_simple','yacc.py',239),
  ('expression -> simple_expression RELOP simple_expression','expression',3,'p_expression_with_relational_op','yacc.py',243),
  ('simple_expression -> term','simple_expression',1,'p_simple_expression_single_term','yacc.py',247),
  ('simple_expression -> simple_expression ADDOP term','simple_expression',3,'p_simple_expression_with_addop','yacc.py',251),
  ('term -> factor','term',1,'p_term_single_factor','yacc.py',256),
  ('term -> term MULOP factor','term',3,'p_term_with_mulop','yacc.py',260),
  ('factor -> num','factor',1,'p_factor_num','yacc.py',265),
  ('factor -> variable','factor',1,'p_factor_variable','yacc.py',269),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expression','yacc.py',273),
  ('factor -> ID LPAREN expression_list RPAREN','factor',4,'p_factor_function_call','yacc.py',277),
  ('factor -> NOT factor','factor',2,'p_factor_not','yacc.py',281),
  ('factor -> ADDOP factor','factor',2,'p_factor_addop','yacc.py',285),
]
